    ...
    <section class="section-pad">
        <div class="container">
            ...
            <ul class="home-e__liste-services md:grid md:grid-cols-2 lg:grid-cols-4 lg:my-24">
                <li>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="113.75" height="101.854" viewBox="0 0 113.75 101.854">
                ...
                <li>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="113.439" height="101.854" viewBox="0 0 113.439 101.854">
