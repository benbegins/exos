        ...
        <div class="container lg:flex">
            ...
            <div class="doc-utiles lg:w-7/12">
                ...
                <div class="mt-8 lg:mt-10 grid grid-cols-2 gap-4 lg:gap-8">
                    <!-- CONSEIL CV -->
                    <?php if($conseils_cv): ?>
                    <a href="<?php echo $conseils_cv['url']; ?>" class="doc-download">
                    ...
                    <a href="<?php echo $conseils_entretien['url']; ?>" class="doc-download">
                        <div class="doc-download__icon">
                ...
                <div class="mt-8 lg:mt-10 grid grid-cols-2 gap-4 lg:gap-8">
                    ...
                    <a href="<?php echo $releve_heures['url']; ?>" class="doc-download">
                        <div class="doc-download__icon">
                ...
                <div class="mt-8 lg:mt-10 grid grid-cols-2 gap-4 lg:gap-8">
                    ...
                    <?php if($mission): ?>
                    <a href="<?php echo $mission['url']; ?>" class="doc-download">
                        <div class="doc-download__icon">
                    ...
                    <!-- PASSEPORT -->
                    <?php if($passeport): ?>
                    <a href="<?php echo $passeport['url']; ?>" class="doc-download">
                        <div class="doc-download__icon">
                ...
                <div class="mt-8 lg:mt-10 grid grid-cols-2 gap-4 lg:gap-8">
                    ...
                    <a href="<?php echo $avantages_interimaires['url']; ?>" class="doc-download">
                        <div class="doc-download__icon">
                    ...
                    <a href="<?php echo $notice_prevoyance['url']; ?>" class="doc-download">
                        <div class="doc-download__icon">
                    ...
                    <a href="<?php echo $notice_complementaire_sante['url']; ?>" class="doc-download">
                        <div class="doc-download__icon">
            ...
            <div class="liens-utiles mt-20 lg:mt-0 lg:w-4/12 lg:ml-auto">
                ...
                <ul class="divide-y divide-dark divide-opacity-15 border-b border-dark border-opacity-15 lg:mt-20">
                    <li class="pt-10 pb-3 lg:pt-0">
                        ...
                        <a class="btn-secondary btn-blue mt-1" href="https://www.fastt.org/" target="_blank">fastt.org</a>
                    </li>
                    <li class="pt-10 pb-3">
                        <p>Fonds d'assurance formation du travail temporaire</p>
                        <a class="btn-secondary btn-blue mt-1" href="https://www.faftt.fr/site/j_6/fr/accueil" target="_blank">faftt.fr</a>
                    </li>
                    <li class="pt-10 pb-3">
                        <p>Pôle emploi</p>
                        <a class="btn-secondary btn-blue mt-1" href="https://www.pole-emploi.fr" target="_blank">pole-emploi.fr</a>
                    </li>
                    <li class="pt-10 pb-3">
                        <p>Outil en ligne de création de CV</p>
                        <a class="btn-secondary btn-blue mt-1" href="https://moncv.com/" target="_blank">moncv.com</a>
                    </li>
                    <li class="pt-10 pb-3">
                        <p>La complémentaire santé des intérimaires</p>
                        <a class="btn-secondary btn-blue mt-1" href="https://www.interimairessante.fr/" target="_blank">interimairessante.fr</a>
                    </li>
                    <li class="pt-10 pb-3">
                        <p>La prévoyance des intérimaires</p>
                        <a class="btn-secondary btn-blue mt-1" href="https://www.interimairesprevoyance.fr/" target="_blank">interimairesprevoyance.fr</a>
                    </li>
                </ul>
            </div>     
        </div>
        ...
        <div class="container">
            <div class="bg-blue text-light rounded-md px-6 py-12 md:p-12 lg:flex lg:items-center lg:p-0 xl:w-10/12 xl:mx-auto">
                <div class="lg:w-4/12 lg:relative lg:ml-24">
                    ...
                    <a href="<?php echo $guide_armado['url']; ?>" target="_blank" class="btn-secondary btn-white">Voir le guide</a><br>
                    <a href="https://myarmado.fr/" class="btn-primary btn-white-2 mt-4" target="_blank">Accès à Armado</a>
                </div>
