    ...
    <section class="section-split">
        ...
        <div class="section-split__text py-10">
            <div class="container">
                ...
                <p class="hidden lg:block mt-8 lg:mt-10">Nous sommes votre partenaire de confiance depuis 2002, du recrutement clé en main au sourcing de candidats, dans les fonctions supports et industrie-ingénierie.</p>
