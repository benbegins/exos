...
<div id="page" class="site">
    ...
    <header class="site-header fixed w-full z-30 flex items-center justify-between px-5 bg-light lg:px-10 lg:py-2">
        ...
        <div class="site-header__cta">
            <a href="<?php echo get_site_url(); ?>/entreprise/contact" class="bg-blue text-light text-sm sm:text-base lg:hover:bg-orange lg:transition duration-200 lg:rounded-md">Nous <br>contacter</a>
        </div>
